...
La solución que se llevará a cabo será implementar una simplificación del patrón Event Sourcing combinado con una tabla de base de datos transaccional. Se usarán estados en los eventos como "listo para publicar", estos eventos se almacenarán en una tabla llamada IntegrationEventLog y se actualizará su estado según vaya progresando en sus fases desde que se crea el evento hasta que se publica.
