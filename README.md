...
Cada microservicio tendrá su propia tabla IntegrationEventLog en su base de datos relacional. Esa tabla funciona como un resguardo para lograr la atomicidad, de modo que se persistan los eventos en las mismas transacciones que se persisten los datos de su dominio.
